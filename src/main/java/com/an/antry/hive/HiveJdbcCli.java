...
/**
 * Hive的JavaApi 启动hive的远程服务接口命令行执行：hive --service hiveserver >/dev/null 2>/dev/null &
 * 
 */
public class HiveJdbcCli {
    private static final Logger LOGGER = LoggerFactory.getLogger(HiveJdbcCli.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
            LOGGER.error("{} not found!", driverName, e);
            System.exit(1);
